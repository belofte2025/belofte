...
exports.generateBulkImportTemplate = exports.generateSupplierTemplate = exports.generateCustomerTemplate = void 0;
...
const generateBulkImportTemplate = async (req, res) => {
    try {
        // Create a new workbook
        const wb = XLSX.utils.book_new();
        // 1. CUSTOMERS SHEET
...
exports.generateBulkImportTemplate = generateBulkImportTemplate;
