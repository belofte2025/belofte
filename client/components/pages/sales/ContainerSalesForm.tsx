      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Container Sale</h1>
              <p className="text-gray-600">Container: {containerNo || "Loading..."}</p>
            </div>
          </div>
        </div>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <div className="text-right ml-4">
                            ...
                            <Badge 
                              variant={item.remainingQty > 10 ? "success" : item.remainingQty > 0 ? "warning" : "danger"}
                              size="sm"
                            >
                              {item.remainingQty} in stock
                            </Badge>
                          </div>
