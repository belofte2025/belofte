            ...
            <div className="mb-6">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors duration-200"
                />
                {searchQuery && (
                  <button
                    onClick={() => filterSales("")}
