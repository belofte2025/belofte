...
export default function SupplierSummaryPage() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      // Build content for sales details
      const salesContent = filtered
        .map(
          (s) => `
      ...
      const html = createHTMLReportTemplate(
        `${search ? search.toUpperCase() + " " : ""}Sales Summary Report`,
        content,
        {
          subtitle: `Date Period: ${new Date(
            startDate
      ...
      const options = {
        ...getHTML2PDFOptions(),
        filename: `Supplier_Sales_Summary_${startDate}_to_${endDate}.pdf`
      };
      html2pdf()
        .set(options)
        .from(html)
    ...
    <DashboardLayout>
      <div className="space-y-4">
          ...
          <div className="page-header">
            ...
            <h1 className="page-title">Sales Details</h1>
          </div>
